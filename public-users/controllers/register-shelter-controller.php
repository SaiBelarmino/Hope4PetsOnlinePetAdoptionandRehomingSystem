...
// ------------------------------------------------------------------
// ⚠️ FIX: DEFINE THE CLASS BEFORE IT IS USED 
// ------------------------------------------------------------------
class RegisterShelterController extends BaseController {
    ...
    public static function register(int $userId, array $data): array {
        ...
        if (!$stmt) {
            // Provide a better error message for database debugging
            return ['success' => false, 'message' => 'Database prepare error: ' . $mysqli->error];
        }
        ...
        if ($success) {
            return ['success' => true, 'message' => 'Shelter registered successfully!'];
             ...
             // Provide a better error message for database debugging
            return ['success' => false, 'message' => 'Registration failed. MySQL error: ' . $stmt->error];
        }
    }

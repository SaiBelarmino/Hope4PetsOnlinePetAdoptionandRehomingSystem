...
<!-- Post Management: Create or Edit Post connected to CreatePostController and IndexController for fetching existing post data and also handling form submissions modal to show ins the index.php after creating a new post -->

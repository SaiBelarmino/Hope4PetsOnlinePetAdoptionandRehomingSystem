        ...
        <div class="col-12 col-lg-5">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    // Auto-hide after 4s
                    setTimeout(function() {
                        var a = document.getElementById('autoHideAlert');
                        if (a) {
                    ...
                    <div class="alert alert-info">You already have a registered shelter. You can manage it from your
                        profile or upload verification documents.</div>
                    <div class="d-flex justify-content-end">
                        <a href="./upload_shelter_documents.php" class="btn btn-secondary btn-sm me-2">Upload
                            Documents</a>
                    ...
                    <form action="../controllers/ShelterRegistrationController.php" method="post" class="row g-3">
                        <div class="col-12 col-md-6">
                            ...
                            <input type="text" name="shelter_name" class="form-control" required maxlength="255"
                                placeholder="e.g. Happy Paws Shelter">
                        </div>
                        <div class="col-12 col-md-6">
                            <label class="form-label">Contact Number</label>
                            <input type="text" name="contact_number" class="form-control" required maxlength="50"
                        ...
                        <div class="col-12">
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="agree">I confirm the information provided is
                                    accurate.</label>
                            </div>
                        </div>
                        <div class="col-12 d-flex justify-content-end">
                            <button type="submit" class="btn btn-primary"><i class="ti ti-building-community"></i>
...
document.querySelector('form').addEventListener('submit', function() {
    ...
    const addressParts = fields.map(id => document.querySelector(`[name="${id}"]`).value.trim()).filter(val =>
        val);

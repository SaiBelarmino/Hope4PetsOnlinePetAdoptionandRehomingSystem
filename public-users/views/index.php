  ...
  <div class="row g-3 py-3">
      ...
      <div class="card">
        <div class="card-body">
          ...
          <div class="d-grid gap-2">
            <a href="./shelters.php" class="btn btn-outline-primary"><i class="ti ti-building-community me-1"></i> Find Shelters</a>
            <a href="./pets.php" class="btn btn-outline-secondary"><i class="ti ti-search me-1"></i> Browse Pets</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="col-12 col-lg-6">
      ...
      <div class="card mb-3">
        <div class="card-body">
          <div class="d-flex align-items-start">
            <img src="../../assets/images/profile/user-1.jpg" class="rounded-circle me-3" width="44" height="44" alt="" />
            <a href="./create_post.php" class="form-control text-start text-muted" style="text-decoration:none;">
      ...
      <div class="card mb-3">
        <div class="card-body">
          <div class="d-flex align-items-center mb-2">
            <img src="../../assets/images/profile/user-2.jpg" class="rounded-circle me-2" width="36" height="36" alt="" />
            <div>
      ...
      <div class="card mb-3">
        <div class="card-body">
          <div class="d-flex align-items-center mb-2">
            <img src="../../assets/images/profile/user-3.jpg" class="rounded-circle me-2" width="36" height="36" alt="" />
            <div>
        ...
        <div class="card-body">
          ...
          <div class="list-group list-group-flush">
            <a class="list-group-item px-0 d-flex align-items-center" href="./shelter_view.php?id=1">
              <img src="../../assets/images/profile/user-4.jpg" class="rounded-circle me-2" width="28" height="28" alt="" />
              <span>Paws Rescue PH</span>
            </a>
            <a class="list-group-item px-0 d-flex align-items-center" href="./shelter_view.php?id=2">
              <img src="../../assets/images/profile/user-5.jpg" class="rounded-circle me-2" width="28" height="28" alt="" />
              <span>Cat Haven QC</span>
            </a>
            <a class="list-group-item px-0 d-flex align-items-center" href="./shelter_view.php?id=3">
              <img src="../../assets/images/profile/user-6.jpg" class="rounded-circle me-2" width="28" height="28" alt="" />

        ...
        <div class="col-12 col-lg-6">
            <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-3">
                ...
                <div class="d-flex gap-2">
                    <a href="./pets.php" class="btn btn-sm btn-outline-primary"><i class="ti ti-search"></i> Find
                        Pets</a>
                    <?php if ($hasShelter): ?><button type="button" class="btn btn-sm btn-primary"
                        data-bs-toggle="modal" data-bs-target="#addPetModal">Add Pet</button><?php endif; ?>
                </div>
            </div>
                    ...
                    <div class="row g-2 align-items-center">
                        <div class="col-12 col-md-6">
                            <div class="input-group">
                                ...
                                <input id="pet-search" type="search" class="form-control"
                        ...
                        <div class="col-6 col-md-3 text-end d-none d-md-block">
                            <small class="text-muted">Showing <span
                                    id="pet-count"><?php echo (int)count($pets ?? []); ?></span> pets</small>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="pet-grid-scroll"
                style="max-height:60vh; overflow-y:auto; overscroll-behavior:y-contain; padding-right:8px;">
                <div class="row g-3" id="pet-grid">
                    <?php if (empty($pets)): ?>
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body text-center text-muted py-5">No pets found.</div>
                        </div>
                    </div>
          ...
          ?>
                    <div class="col-12 col-sm-6 col-md-4">
                        <div class="card h-100 pet-card"
                            ...
                            data-breed="<?php echo htmlspecialchars(strtolower($p['breed'] ?? '')); ?>"
                            data-species="<?php echo htmlspecialchars(strtolower($p['species'] ?? '')); ?>"
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-start mb-2">
                                    <div>
                                        <h6 class="mb-0 fw-semibold"><a
                                                href="./pet_view.php?id=<?php echo (int)$p['id']; ?>"
                                    ...
                                    <div class="text-end">
                                        <span
                                            class="badge bg-<?php echo ($status==='available')? 'success' : (($status==='adopted')? 'secondary' : 'warning'); ?>"><?php echo htmlspecialchars(ucfirst($status)); ?></span>
                                    </div>
                                </div>

                                <!-- Additional details -->
                                <div class="mb-2 small">
                                    <span class="me-2"><strong>Species:</strong>
                                        <?php echo htmlspecialchars(ucfirst($p['species'] ?? 'Other')); ?></span>
                                    <span class="me-2"><strong>Gender:</strong>
                                        <?php echo htmlspecialchars(ucfirst($p['gender'] ?? 'Unknown')); ?></span>
                                    <span><strong>Size:</strong>
                                        <?php echo htmlspecialchars(ucfirst($p['size'] ?? 'Medium')); ?></span>
                                </div>
                                <div class="mb-2 small text-truncate"><strong>Vaccine:</strong>
                                    <?php echo htmlspecialchars($p['vaccine_status'] ?? 'N/A'); ?></div>
                                <div class="mb-2 small text-truncate"><strong>Health:</strong>
                                    <?php echo htmlspecialchars($p['health_status'] ?? 'N/A'); ?></div>
                                <div class="mb-2 small text-truncate text-muted"><i class="ti ti-map-pin"></i>
                                    <?php echo htmlspecialchars($p['location'] ?? 'Unknown'); ?></div>

                                <p class="small text-truncate mb-2">
                                    <?php echo htmlspecialchars($p['description'] ?? 'No description'); ?></p>
                                <div class="d-flex gap-2">
                                    <button class="btn btn-sm btn-outline-primary flex-grow-1 btn-view"
                                        data-pet='<?php $p_data['photo'] = htmlspecialchars($photoFullUrl); echo json_encode($p_data, JSON_HEX_APOS|JSON_HEX_QUOT); ?>'
                                        type="button">View</button>
                                    <?php if ($hasShelter): ?>
                                    <button class="btn btn-sm btn-outline-secondary btn-edit"
                                        data-pet='<?php echo json_encode($p, JSON_HEX_APOS|JSON_HEX_QUOT); ?>'
                                        data-bs-toggle="modal" data-bs-target="#editPetModal"
                                        type="button">Edit</button>
                                    <button class="btn btn-sm btn-outline-danger"
                                        onclick="deletePet(<?php echo (int)$p['id']; ?>, this)"
           ...
           <div class="col-12 col-lg-2">
               <div class="card mb-3">
                   <div class="card-header bg-white border-0 pb-0">
                       <h6 class="mb-0">Management Tips</h6>
                   </div>
                   <div class="card-body small">
                       <p class="text-muted mb-2">Regularly review and update pet health and status information.</p>
                       <p class="text-muted mb-2">Respond promptly to adoption inquiries.</p>
                       <p class="text-muted mb-2">Keep pet profiles updated to attract adopters.</p>
                   </div>
               </div>
           </div>
    </div>
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <div class="mb-2">
                                <label class="form-label">Photos (you can select multiple) - first image will be
                                    primary</label>
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <div class="mb-2">
                                <label class="form-label">Description</label>
                                <textarea name="description" id="editPetDescription" class="form-control"
                                    rows="3"></textarea>
                            </div>
                            <div class="mb-2">
                                <label class="form-label">Photos (optional - you can select multiple to replace
                                    existing)</label>
                                <input name="photos[]" type="file" class="form-control" accept="image/*" multiple
                                    id="editPetPhotos">
                        ...
                        <div class="col-12">
                            <div class="mb-2">
                                ...
                                <div>
                                    <input type="radio" name="status" value="available" id="editStatusAvailable"> <label
                                        for="editStatusAvailable">Available</label>
                                    <input type="radio" name="status" value="adopted" id="editStatusAdopted"
                                        style="margin-left: 20px;"> <label for="editStatusAdopted">Adopted</label>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12 col-md-6">
                        <dl class="row">
                            ...
                            <dd class="col-8" id="petDetailBreed"></dd>
                            <dt class="col-4">Age</dt>
                            <dd class="col-8" id="petDetailAge"></dd>
                            <dt class="col-4">Species</dt>
                            <dd class="col-8" id="petDetailSpecies"></dd>
                            <dt class="col-4">Gender</dt>
                            <dd class="col-8" id="petDetailGender"></dd>
                            <dt class="col-4">Size</dt>
                            <dd class="col-8" id="petDetailSize"></dd>
                            <dt class="col-4">Status</dt>
                            <dd class="col-8"><span id="petDetailStatus" class="badge bg-success"></span></dd>
                            <dt class="col-4">Vaccine</dt>
                            <dd class="col-8" id="petDetailVaccine"></dd>
                            <dt class="col-4">Health</dt>
                            <dd class="col-8" id="petDetailHealth"></dd>
                            <dt class="col-4">Location</dt>
                            <dd class="col-8" id="petDetailLocation"></dd>
                            <dt class="col-4">Added</dt>
                            <dd class="col-8" id="petDetailAdded"></dd>
                        </dl>

...
// Removed shelter button per requirement (page-specific actions kept minimal)
?>
...
<div class="pu-scroll-wrapper"><div class="container-fluid">
  ...
  <div class="card"><div class="card-body"><!-- Placeholder: shelter registration form --></div></div>
 </div></div>

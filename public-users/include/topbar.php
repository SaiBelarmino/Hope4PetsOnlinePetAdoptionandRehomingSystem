...
<nav class="topbar navbar navbar-expand-lg navbar-light bg-white border-bottom sticky-top shadow-sm py-2 py-lg-2"
    ...
    <div class="container-fluid align-items-center d-flex gap-2 gap-lg-3">
        ...
        <ul class="topbar-icons navbar-nav flex-row align-items-center d-none d-lg-flex ms-1">
            <li class="nav-item"><a class="nav-link" href="./index.php" title="Home" aria-label="Home"><i
                        class="ti ti-home icon-huge"></i></a></li>
            <li class="nav-item"><a class="nav-link" href="./community.php" title="Community" aria-label="Community"><i
                        class="ti ti-users icon-huge"></i></a></li>
            <li class="nav-item"><a class="nav-link" href="./pets.php" title="Pets" aria-label="Pets"><i
                        class="ti ti-paw icon-huge"></i></a></li>
            <li class="nav-item"><a class="nav-link" href="./shelters.php" title="Shelters" aria-label="Shelters"><i
                        class="ti ti-building-community icon-huge"></i></a></li>
            <li class="nav-item"><a class="nav-link" href="./adoptions.php" title="Adoptions" aria-label="Adoptions"><i
                        class="ti ti-heart-handshake icon-huge"></i></a></li>
            <li class="nav-item"><a class="nav-link" href="./events.php" title="Events" aria-label="Events"><i
                        class="ti ti-calendar-event icon-huge"></i></a></li>
            <li class="nav-item"><a class="nav-link" href="./favorites.php" title="Favorites" aria-label="Favorites"><i
                        class="ti ti-star icon-huge"></i></a></li>
            <li class="nav-item"><a class="nav-link" href="./messages.php" title="Messages" aria-label="Messages"><i
                        class="ti ti-message-circle icon-huge"></i></a></li>
        </ul>
        ...
        <div class="d-flex align-items-center ms-auto gap-2">
            <a class="nav-link position-relative p-0 d-flex align-items-center justify-content-center"
                ...
                <span
                    class="notification-dot bg-danger rounded-circle position-absolute top-25 start-75 translate-middle"></span>
            </a>
    ...
    <div class="collapse navbar-collapse collapse-area border-top px-3 px-md-4" id="communityNav">
        ...
        <ul class="navbar-nav mobile-nav mb-3 d-lg-none w-100">
            ...
            <li class="nav-item mt-2 mb-3"><a href="<?php echo htmlspecialchars($shelterCtaHref); ?>"
                    class="btn btn-primary w-100 btn-shelter-cta"><i class="ti ti-building-community"></i>
                    <?php echo htmlspecialchars($shelterCtaLabel); ?></a></li>
        </ul>
    </div>
</nav>
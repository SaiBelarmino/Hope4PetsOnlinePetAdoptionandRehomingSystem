...
body.pu-layout .page-wrapper .body-wrapper {
    flex: 1 1 auto;
    display: flex;
    flex-direction: column;
    min-height: 0;
...
body.pu-layout .pu-scroll-wrapper,
body.pu-layout .container-fluid {
    flex: 1 1 auto;
    overflow-y: auto;
    min-height: 0;
...
body.pu-layout header.app-header {
    position: sticky;
    top: 0;
    z-index: 1030;
}
